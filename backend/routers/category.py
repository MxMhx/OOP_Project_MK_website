...
mk.get_category("โปรโมชั่น").add_product(Product("Meat Lover Set","https://www.mk1642.com/getattachment/78f03b34-e8f7-4f1d-9899-c2489efe8ea1/4202.aspx",599,"เลือกได้ 10 เมนูเลย","1800","ชุดสุดคุ้ม"))
mk.get_category("โปรโมชั่น").add_product(Product("Super Combo Set","https://www.mk1642.com/getattachment/286abd5a-d0f2-43a6-a5df-bf7814e32067/4201.aspx",339,"คอมโบคุ้มโคตรครบ","2400","ชุดสุดคุ้ม"))
mk.get_category("โปรโมชั่น").add_product(Product("Happy Party Set","https://www.mk1642.com/getattachment/f16d0a6b-ff29-4654-8c27-c19a45141fe8/4160.aspx",499,"เมนูนี้มีส่วนผสมของกุ้ง","1500","ชุดสุดคุ้ม"))
mk.get_category("โปรโมชั่น").add_product(Product("เห็ดออรินจิน้ำมันหอย","https://www.mk1642.com/getattachment/fc83a82e-201f-4f7d-b328-3de7d61834d2/4211.aspx",95,"หอมฟิน อร่อยเด็ด","120","จานเดี่ยว"))
mk.get_category("โปรโมชั่น").add_product(Product("เห็ดรวมน้ำมันหอย","https://www.mk1642.com/getattachment/e6147cf2-6712-4e32-ba25-b3aa65c27d91/4210.aspx",95,"ใหม่ต้องลอง!!!","150","จานเดี่ยว"))
